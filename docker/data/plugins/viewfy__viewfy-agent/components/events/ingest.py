...
FORMAT_LINE = (
    ...
    "tool also publishes or skips a blog draft, and sends or skips a link-building "
    "pitch, that used those buttons. "
    ...
    "standing brief for future drafts. If they say not to write to a person or handle, "
    "call scout action=skip with the action_id of the draft they replied to and any "
    "handles they named — that is a hard skip, not a brief revise. "
    "If they type edit without an id, call scout_queue "
